Page({
  ...
  onSubmit(e) {
    ...
    params.name = this.data.userList[this.data.userIndex].member_id
    params.phone = e.detail.formId;
    ...
    params.objectArray = this.data.typeIndex != null ? this.data.typeList[this.data.typeIndex] : null;
