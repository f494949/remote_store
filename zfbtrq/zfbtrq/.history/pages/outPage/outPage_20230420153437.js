...
Page({
  ...
  onSubmit(e){
    ...
    params.value = this.data.arrIndex != null ? this.data.objectArray[this.data.arrIndex] : null;
    params.apiDate = this.data.arrIndex != null ? this.data.objectArray[this.data.arrIndex] : null;
    console.log(params)
